...
exports.transformToBaseUnit = exports.evalUnits = exports.EvalMessages = exports.truncate = void 0;
...
})(EvalMessages = exports.EvalMessages || (exports.EvalMessages = {}));
var getSiValue = function (si) {
    return new bignumber_js_1.BigNumber(10).exponentiatedBy(new bignumber_js_1.BigNumber(si));
};
var si = [
    ...
    { value: new bignumber_js_1.BigNumber(1), symbol: "" },
...
function evalUnits(input, chainDecimals) {
    ...
    var numeric = new bignumber_js_1.BigNumber(0);
    if (!siVal) {
        return [null, EvalMessages.GIBBERISH];
    }
    var decimalsBn = new bignumber_js_1.BigNumber(10).exponentiatedBy(new bignumber_js_1.BigNumber(chainDecimals));
    ...
    var fracExp = new bignumber_js_1.BigNumber(10).exponentiatedBy(new bignumber_js_1.BigNumber(fracDecimals));
    numeric = containDecimal
        ? new bignumber_js_1.BigNumber(new bignumber_js_1.BigNumber(decPart)
            .multipliedBy(fracExp)
            .plus(new bignumber_js_1.BigNumber(fracPart)))
        : new bignumber_js_1.BigNumber(new bignumber_js_1.BigNumber(numberStr));
    ...
    if (numeric.eq(new bignumber_js_1.BigNumber(0))) {
        return [null, EvalMessages.ZERO];
    }
    return [numeric, EvalMessages.SUCCESS];
}
exports.evalUnits = evalUnits;
function transformToBaseUnit(estFee, chainDecimals, returnType, decAmount) {
